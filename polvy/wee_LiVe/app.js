...
var port = process.env.PORT || 5210;
...
app.use(expressJwt({
  ...
  path:['/users/login', '/users/getUserInfo','/livingRoom/roomList','/livingRoom/roomListByType','/livingRoom/roomDetail','/users/addUser','/users/test']
}))
